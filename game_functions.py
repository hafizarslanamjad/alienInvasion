...
def fire_bullet(ai_settings, screen, ship, bullets):
    """Fire bullet if the limit is not reached yet"""
...
def change_fleet_direction(ai_settings, aliens):
    """Drop the entire fleet and the change the fleet's direction"""
...
def check_aliens_bottom(ai_settings, stats, screen, ship, aliens, bullets):
    """Check that if any aliens have reached the bottom of the screen"""
